...
const timeMaps = [{"title":"3个月","value":3},{"title":"6个月","value":6},{"title":"12个月","value":12},{"title":"18个月","value":18},{"title":"24个月","value":24}]
const Telphone = props => {
  ...
  const changeTime = useCallback(index => {
    ...
    <Container>
      ...
      <TabWrapper>
        <Tabs
          ...
          <Combo history={props.history} preCharge={preCharge} setPreCharge={setPreCharge} changeTime={changeTime} />
...
const Combo = props => {
  ...
  return (
    <ComboWrap>
      ...
      <div className="ratina-bd bd-t bd-b" onTouchMove={e => {e.stopPropagation()}}>
        <Slider
          defaultValue={0}
          min={0}
          max={4}
      ...
      <div className="result">
        优惠折扣<span>9.4</span>折 实际为您节约资金<span>180.00</span>元
      </div>
      <div className="reminder">* 1个月套餐将在下月当天充值</div>
      <ListItem extra="6个月" arrow="horizontal" onClick={goSelectCoupon}>充值计划</ListItem>
